api_response_test = {'result': {'CHECKS': {'Account_check': {'Complete_Invoice': {'Gst_Portal': '-',
                       ...
                       'eway_bill_data': {'Invoice_No': {'e-waybill': 'GST '
                                          ...
                                          'reason': 'Vendor is liable to raise '
                                                    ...
                                                    'Number is Not Valid',
                                          'status': 'not okay'},
                       'table_data': {'Table_Check_data': '[{"item_description":"DP Angle","item_quantity":13.0,"unit_price":338.0,'
                       '"product_code":"998873","tax_rate":6.0,"amount":4394.0,"qty_unitprice":4394.0,"qty_unit+rate_qty_unit":4657.64,'
                       '"qty_unit+2_rate_qty_unit":4921.28,"check1":"correct"}]'},
...
def extract_invoice_core_fields(api_response):
    ...
    return {
        ...
        "invoice_value": float(invoice_data.get("InvoiceTotal", 0)),
    }
